...
- 1 million healthy life years (DALYs) lost each year (Western Europe)

--

- 147 billion euros per year (social cost in France)
...
--
- Traditionnal way is simulation from traffic counts and infrastructure

<img src="media/carte-bruit-bouguenais.png" style="width: 50%" />

---
### Proposal : Capture sound environment with a smartphone app.
...
## Characterization of the user environment with the collected data ?
...
If the tags can help to qualify the sound spectrum, it will be a real plus.
...
--
.pull-right[<img src="https://universite-gustave-eiffel.github.io/lasso-data-analysis/articles/plots/tags_repartition.png" style="width: 100%" />]
---
...
--
.pull-left[
<img src="https://user-images.githubusercontent.com/86657953/168254217-d18e7476-fa3c-48e8-9412-1886183ea98e.png" style="width: 100%" />
]
...
The graph on the left shows the proportion of the "animals" tags around sunrise time (the center is the sunrise time of the day it was recorded). We can see a peak during the 3 hours after the sunrise. It is a well known temporal dynamic for bird songs.

On the right, it is the proportion of "roads" tags (often associated with traffic noise) in local time. We can see two peaks around 9 to 10 am and 8 PM. It is very similar to what is observed with commute times.
...
<img src="https://github.com/nicolas-roelandt/lasso-data-analysis/raw/8f9d0d04e3ccd3dc98f26aa216c79b8a972b56e8/vignettes/plots/Repartition%20wind%20tags.png" style="width: 100%" />
...
.pull-right[
<img src="https://github.com/nicolas-roelandt/lasso-data-analysis/raw/8f9d0d04e3ccd3dc98f26aa216c79b8a972b56e8/vignettes/plots/Repartition%20rain%20tags.png" style="width: 100%" />
...
- Environment info are too scarce
...
- Guix: so far the best way to reproduce and entire environment
...
- FOSS are a not only useful for Science but <span style='color:#ef7d00;'>key for Reproductible Science</span>
- Reproductible Science is hard and has to take in account as soon as possible
