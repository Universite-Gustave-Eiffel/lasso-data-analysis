...
- NoiseModelling: generat noise maps from Open Source geodata
...
- from the sound spectrum (ongoing)
...
- FOSS are <span style='color:#D580E6;'>key for Reproductible Science</span>
- Reproductible Science is <span style='color:#D580E6;'>hard to achieve</span> 
...
- FOSS are a not only useful for the industry and science but <span style='color:#D580E6;'>key for Reproductible Science</span>
- Reproductible Science is <span style='color:#D580E6;'>hard to achieve</span> and has to take in account as soon as possible within the project
