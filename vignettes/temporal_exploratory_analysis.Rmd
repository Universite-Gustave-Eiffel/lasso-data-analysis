...
user="noisecapture",
password=Sys.getenv('noisecapture_password') # password stored in .Renviron. To edit : usethis::edit_r_environ()
)
```
...
```{r time-after-sunrise-animals-graph-save, echo=FALSE, message=FALSE}
...
```{r close-connection, echo=FALSE, message=FALSE}
