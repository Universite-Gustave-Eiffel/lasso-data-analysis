...
The median distance between stations and our tracks is **16.1 kilometers**, resulting 
...
There is a strong correlation between wind tags and the strength of wind (cor = 0.932623, *p < 0.01*).
The correlation between rain tags and the amount of rain is less significative (cor = 0.6815522, *p < 0.1*). However, this might be a perception bias or because of too small groups.
