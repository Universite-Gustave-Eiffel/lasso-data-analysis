...
In order to facilitate the replication of the study on areas without this kind of issues this as not been done within the database but at the begining of the Rmarkdown document where analysis is conducted.
...
knitr::include_graphics("https://nicolas-roelandt.github.io/lasso-data-analysis/articles/temporal_exploratory_analysis_files/figure-html/time-after-sunrise-animals-graph-1.png")
```
...
<!--TODO: Remplacer par le graphique de Ludovic -->
```{r, fig.cap="Road dynamics", include=FALSE}
