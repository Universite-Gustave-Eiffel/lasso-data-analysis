...
de plus 260 000 traçes pour un total d'environ 60 millions de secondes de mesure. 
Une trace est un enregistrement collecté, il contient le spectre sonore (1s, tiers d'octave) enregistré
par le téléphone couplé à son positionnement GPS (1s).
Ces informations peuvent être librement enrichies par des étiquettes par
le contributeur. Elles sont au nombre de X : ...,...,...,...,...,...,...,... 
et l'utilisateur peut séléctionner une ou plusieurs d'entre elle pour chacune des traçes effectuées.
C'est sur l'analyse de ces étiquettes que portent les travaux préliminaires présentés ici.
...
*chatting*, *animals* et *wind*. Les tags *air_traffic* et *works* sont aussi bien représentés.

<!-- Il faut expliquer kkpart que l'on travaille sur la proportion des tags.-->

Un premier axe d'analyse porte sur la répartition horaire des tags.
Les bruits d'animaux (tag *animals*) sont plus fréquents le matin et notamment une heure avant le 
lever du soleil. Il s'agit d'une dynamique courante pour 
le chant des oiseaux [citation oiseaux ici !].
Il est également possible d'observer les pics d'activités humaines 
notamment les trajets domicile-travail [citation].
