...
Lettered programming allows one to go further than just commenting on the code 
...
are also numerous.
The work done is accessible, especially if collaborative work tools have been 
put in place.
...
a detailed document.
It is at this point that lettered programming comes into its own, since more than 
