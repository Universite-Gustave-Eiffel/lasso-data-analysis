...
production of data with smartphones in order to eventually propose an alternative method of assessment of the 
sound environment. For this purpose, an Android application and a spatial data infrastructure 
...
The first step was too find if known temporal dynamics of sound sources are present in the dataset
The first results were encouraging because road sound dynamics related to commuting or 
...
Reproducibility is an important constraint for research projects that often have 
...
the presence of research software engineers is a real plus.
